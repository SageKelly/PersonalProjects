...
namespace SongProofWP8
{
    ...
    public static class ScaleResources
    {
        ...
        static ScaleResources()
        {
            ...
            ScaleNames.Add(ScaleTypes.BebopSuspended, "Bebop Suspended");
            ...
            ScaleLib.Add(ScaleTypes.Aeolian, "2122121");
            ...
            ScaleLib.Add(ScaleTypes.BebopSuspended, "22122111");
            ...
            SuspendedScales.Add(new KVTuple<string, string>(ScaleNames[ScaleTypes.BebopSuspended], ScaleLib[ScaleTypes.BebopSuspended]));
        ...
        public static Scale MakeScale(string starting_key, KVTuple<string, string> scale, bool showSharp)
        {
            ...
            //then find the rest (remove the last note, since the last is the first)
        ...
        public static int[] MakeQuiz(Scale s, int noteCount)
        {
            ...
            {
                //Remove the last note, since the last is the first.
