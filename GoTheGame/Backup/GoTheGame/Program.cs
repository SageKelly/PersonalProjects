...
namespace GoTheGame
{
    ...
    class Program
    {
            ...
            for (int player = 0; player < 4; player++)
            {
                for (int board = 0; board < 4; board++)
                {
                    for (int row = 0; row < boardInput; row++)
                    {
                        ...
                        {
                            Gameboard[player, board, row, column] = null;
                        }
                    }
                }
            }
        ...
        static public void PrintBoard()
        {
            ...
            #endregion
            for (int LetterRepresentative = 0; LetterRepresentative < board_size_input; LetterRepresentative++)
            {
                CL = (ColumnLetters)LetterRepresentative;
                Console.Write(CL + " ");
            }
            Console.WriteLine();
            Console.Write("");
            for (int dash_counter = 0; dash_counter < board_size_input; dash_counter++)
            {
                Console.Write(" -");
            }
            Console.WriteLine();
            for (int row = 0; row < board_size_input; row++)
            {
                ...
                {
                    if (Gameboard[1, 0, row, column] == null)
                    {
                        Console.Write(" |");
                    }
                    else
                    {
                        Console.Write(Gameboard[1, 0, row, column].Symbol + "|");
                    }
                }
                Console.Write((row + 1));
                Console.WriteLine();
        ...
        private static void CreateComboArray(int boardInput)
        {
            ...
            for (int combo_letter = 0; combo_letter < boardInput; combo_letter++)
            {
                CL = (ColumnLetters)combo_letter;
                for (int combo_number = 0; combo_number < boardInput; combo_number++)
                {
                    ComboArray[arrayIncrementor] = ((combo_number + 1).ToString() + CL.ToString());
                    arrayIncrementor++;
                }
            }
            return;
        ...
        static public bool CheckForPossibleCombo(string input)
        {
            ...
            #endregion
            foreach (string possibleCombo in ComboArray)
            {
                if (input == possibleCombo)
                {
                    ComboIsValid = true;
                    return ComboIsValid;
                }
        ...
        private static void Capture()
        {
            ...
            foreach (Piece piece in ConnectedPieces)
            {
                ...
                if (piece.Captured)
                {
                    Gameboard[1,0,piece.Register.Row, piece.Register.Column] = null;
                }
            }
            ...
            for (int row = 0; row < board_size_input; row++)
            {
                for (int column = 0; column < board_size_input; column++)
                {
                    if (Gameboard[1, 0, row, column] != null)
                    {
                        ...
                        if (row != 0)
                        {
                            if (Gameboard[1, 0, row - 1, column] == null)
                                Gameboard[1, 0, row, column].Top = null;
                            else
                                Gameboard[1, 0, row, column].Top = Gameboard[1, 0, row - 1, column];
                        }
                        else
                            Gameboard[1, 0, row, column].Top = null;
                        #endregion
                        ...
                        {
                            if (Gameboard[1, 0, row, column + 1] == null)
                                Gameboard[1, 0, row, column].Right = null;
                            else
                                Gameboard[1, 0, row, column].Right = Gameboard[1, 0, row, column + 1];
                        }
                        else
                            Gameboard[1, 0, row, column].Right = null;
                        #endregion
                        ...
                        {
                            if (Gameboard[1, 0, row + 1, column] == null)
                                Gameboard[1, 0, row, column].Bottom = null;
                            else
                                Gameboard[1, 0, row, column].Bottom = Gameboard[1, 0, row + 1, column];
                        }
                        else
                            Gameboard[1, 0, row, column].Bottom = null;
                        #endregion
                        ...
                        {
                            if (Gameboard[1, 0, row, column - 1] == null)
                                Gameboard[1, 0, row, column].Left = null;
                            else
                                Gameboard[1, 0, row, column].Left = Gameboard[1, 0, row, column - 1];
                        }
                        else
                            Gameboard[1, 0, row, column].Left = null;
                        #endregion
                        ...
                        {
                            Gameboard[1, 0, row, column].InCorner = true;
                        }
                        ...
                        {
                            Gameboard[1, 0, row, column].OnEdge = true;
                        }
                        #endregion
                    }
                }
        ...
        public static void CompareSnapshotsToTestBoard(Piece newPiece)
        {
            ...
            if (similarities == (board_size_input * board_size_input))
            {
                ...
                Gameboard[1, 0, newPiece.Register.Row, newPiece.Register.Column] = null;
                return;
            }
            #endregion
            else
        ...
        public static void TakeSnapshotOfGameboardAtTurn1()
        {
            for (int row = 0; row < board_size_input; row++)
            {
                for (int column = 0; column < board_size_input; column++)
                {
                    if (Gameboard[1, 0, row, column] != null)
                    {
                        SnapShotOfTurn1[row, column] = new Piece(Gameboard[1, 0, row, column].Register.Row,
                            Gameboard[1, 0, row, column].Register.Column,
                            Gameboard[1, 0, row, column].Symbol,
                            Gameboard[1, 0, row, column].Turn_Created);
                    }
                    else
        ...
        public static void TakeSnapshotOfGameboardAtTurn2()
        {
            for (int row = 0; row < board_size_input; row++)
            {
                for (int column = 0; column < board_size_input; column++)
                {
                    if (Gameboard[1,0,row, column] != null)
                    {
                        SnapShotOfTurn2[row, column] = new Piece(Gameboard[1,0,row, column].Register.Row,
                            Gameboard[1,0,row, column].Register.Column,
                            Gameboard[1,0,row, column].Symbol,
                            Gameboard[1,0,row, column].Turn_Created);
                    }
        ...
        public static void CopyGameBoardToTestBoard()
        {
            for (int row = 0; row < board_size_input; row++)
            {
                for (int column = 0; column < board_size_input; column++)
                {
                    ...
                    {
                        TestBoardForKo[row, column] = new Piece(Gameboard[1,0,row, column].Register.Row,
                            Gameboard[1,0,row, column].Register.Column,
                            Gameboard[1,0,row, column].Symbol,
                            Gameboard[1,0,row, column].Turn_Created);
                    }
        ...
        private static void UpdatePiecesInTestBoard()
        {
            for (int row = 0; row < board_size_input; row++)
            {
                for (int column = 0; column < board_size_input; column++)
                {
                    if (TestBoardForKo[0, 0, row, column] != null)
                    {
                        /*Set Piece's Top, Right, Bottom, and Left equal
                        to the right addresses on the Gameboard.*/
                        #region Piece Update
                        ...
                        case GameStates.GameSetUp:
                            ...
                            if (gameOver != true && GS != GameStates.Instructions)
                            {
                                ...
                                do
                                {
                                    ...
                                    if (board_size_input != 9 && board_size_input != 13 && board_size_input != 19)
                                    {
                                        Console.WriteLine("Incorrect board dimensions entered.");
                                    }
                                    else
                                    {
                                ...
                                } while (board_size_input != 9 && board_size_input != 13 && board_size_input != 19);
                                #endregion
                            }
                        ...
                        case GameStates.Tp1:
                            ...
                            else
                            {
                                ...
                                if (ComboIsValid == true)
                                {
                                    ...
                                    if (Gameboard[1,0,subnum, CL.GetHashCode()] == null)
                                    {
                                        Gameboard[1,0,subnum, CL.GetHashCode()] = new Piece(subnum, CL.GetHashCode(), player1.Symbol, turn_number);
                                    #endregion
                                        /*These methods were explained in their own method blocks.*/
                                        UpdatePieces();
                                        CheckForKo(Gameboard[1,0,subnum, CL.GetHashCode()]);
                                        if (!KoViolationFound)
                                        {
                                            StartCaptureProcess();
                        ...
                        case GameStates.Tp2:
                            ...
                            else
                            {
                                ...
                                if (ComboIsValid == true)
                                {
                                    ...
                                    if (Gameboard[1,0,subnum, CL.GetHashCode()] == null)
                                    {
                                        Gameboard[1,0,subnum, CL.GetHashCode()] = new Piece(subnum, CL.GetHashCode(), player2.Symbol, turn_number);
                                    #endregion
                                        UpdatePieces();
                                        CheckForKo(Gameboard[1,0,subnum, CL.GetHashCode()]);
                                        if (!KoViolationFound)
